  ...
  \cventry
    ...
    {Sep. 2021 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Relevant Modules: Machine Learning for Visual Computing, Image Processing, Networked Systems, Machine Vision, Computer Graphics, Robot Vision and Navigation, Virtual Environment, and Computer Graphics.}
      \end{cvitems}
    }
    
  \cventry
    {Computer Science - MSc Artifial Intelligence (class 1 degree - avg. 85+\%)} % Degree
