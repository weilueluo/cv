...
\begin{cvskills}
  ...
  \cvskill
    {DevOps} % Type
    {\href{https://git-scm.com/}{Git}, \href{https://en.wikipedia.org/wiki/Code_review}{CR}, \href{https://aws.amazon.com/}{AWS}, \href{https://www.scrum.org/resources/what-is-scrum}{Scrum}, \href{https://www.docker.com/}{Docker}.}
  ...
  \cvskill
    {Other} % Type
    {Proficient with \href{https://en.wikipedia.org/wiki/Markdown}{markdown}, \href{https://en.wikipedia.org/wiki/Command-line_interface}{command-line}, and \href{https://www.latex-project.org/}{latex}. Familiar with \href{https://en.wikipedia.org/wiki/Unix}{unix} environment \href{https://www.blender.org/}{Blender} and \href{https://unity.com/}{Unity}.}
