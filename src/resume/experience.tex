...
\cventry
      ...
      {Jun. 2022 - Sep. 2022} % Date(s)
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          ...
          \item {Improve and implement a number of state-of-the-art ML papers and build a pipeline that aids artists' development process.}
          \item {Built the machine learning pipeline from scratch, and presented a proof-of-concept master thesis that is high-rated by professors and engineers.}
        \end{cvitems}
      }
  ...
  \cventry
    ...
    {Jun. 2020 - Sep. 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Develop procedures that aggregate \approx3 billion item records into concise datasets daily using tools based on Spark. Built an effective modern visualization dashboard with these datasets using Elastic Search and Kibana.}
