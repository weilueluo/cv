...
\cventry
      ...
      {Oct. 2022 - Nov. 2022} % Date(s)
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          \item {Mentored a group of 8 second year undergraduate students as they contribute to a open source project.}
          \item {Demonstrated leaderships and received positive feedback from students.}
        \end{cvitems}
      }
