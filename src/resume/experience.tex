...
\cventry
    ...
    {Oct. 2022 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Contributes to development and maintainance of a cloud-based device manager that facilitates management of security policies in highly distributed environments.}
      \end{cvitems}
    }
