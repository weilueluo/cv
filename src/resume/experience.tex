...
\cventry
    {Software Engineer - Java \& Typescript} % Job title
    {Cisco} % Organization
    {London, UK} % Location
    {Oct. 2022 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Contributes to the development of a device manager that facilitates security policies management in highly distributed environments.}
        \item {Facilitates the deployment of business solutions in cloud-native environments such as AWS and Azure.}
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {Software Engineer Internship - Java \& Python} % Job title
    {Amazon} % Organization
