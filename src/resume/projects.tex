...
\cventry
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s)
        \item {A tool for parsing and manipulating propositional logic formulas, supports conversion to normal forms, push negations, tautology and contradiction checks and truth table generation. Project can be found at \href{https://github.com/Redcxx/PropositionalLogicUtils}{https://github.com/Redcxx/PropositionalLogicUtils}.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s)
        \item {Designed and implemented an API supports automatic login, multithreading downloading, various format parsing and filter images, along with a graphical user interface. Project can be found at \href{https://github.com/Redcxx/Pikax}{\textit{https://github.com/Redcxx/Pikax}}.}
      \end{cvitems}
    }
  ...
  {
    \begin{cvitems} % Description(s)
      \item {Built a multi-processing library for generating photographic mosaic, capable of processing and matching over 30k images within 3 minutes, supports various RGB-based and LAB-based color difference algorithms. Project can be found at \href{https://github.com/Redcxx/Mosaic-Pics}{https://github.com/Redcxx/Mosaic-Pics}.}
    \end{cvitems}
  }
  ...
  \cventry
    ...
    {Jan. 2019 - Mar. 2019} % Date(s)
    {
      \begin{cvitems} % Description(s)
        ...
        \item {Designed and implemented all core functionalities including real-time chatting, coding, and drawing with collaborators, supports online code compilation and web-embed terminal.}
