...
%---------------------------------------------------------
  % \cventry
  %   {Sole Developer - HTML/CSS, Typescript, and GLSL} % Role
...
%---------------------------------------------------------
  \cventry
    {Lead Developer - HTML/CSS, and Javascript} % Job title
...
\cventry
  ...
  {Mar. 2019 - Jun. 2019} % Date(s)
  {
    \begin{cvitems} % Description(s)
      ...
      \item {The only student that completed this university coursework over last 5 years.}
    \end{cvitems}
  }
