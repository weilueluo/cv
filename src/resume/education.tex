...
%---------------------------------------------------------
  \cventry
    {Computer Science - MSc Computer Graphics, Vision \& Imaging (current avg. 90+\%)} % Degree
    {University College London} % Institution
    {London, UK} % Location
    {Sep. 2021 - Present - Sep. 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Relevant Modules: Machine Learning for Visual Computing, Image Processing, Networked Systems, Machine Vision, Computer Graphics, Robot Vision and Navigation, and Virtual Environment.}
      \end{cvitems}
    }
    
  \cventry
    {Computer Science - BSc Artifial Intelligence (class 1 degree - avg. 85+\%)} % Degree
