...
%---------------------------------------------------------
  \cventry
    {Computer Science - MSc Computer Graphics, Vision \& Imaging (Distinction - expected avg. 85+\%)} % Degree
  ...
  \cventry
    {Computer Science - BSc Artifial Intelligence (Distinction - avg. 85+\%)} % Degree
